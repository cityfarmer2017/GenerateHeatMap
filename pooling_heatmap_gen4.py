...
def plot_top_aligned_heatmaps(heatmap_upper, heatmap_lower, func, title_prefix="Heatmap", cmap='viridis', show_values=False, save_path=None):
    ...
    # Create GridSpec: 1 row, 2 columns for heatmaps, plus space for colorbar
    gs = GridSpec(1, 3, width_ratios=[16, 4, 1], wspace=0.3)
    ...
    # Plot lower case heatmap (middle)
